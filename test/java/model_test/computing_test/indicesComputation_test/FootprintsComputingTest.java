...
public class FootprintsComputingTest {


    private AppInterface testApp;
    private FootprintsComputing testFoot;
    ...
    public void setUp() {
        ...
        testFoot = new FootprintsComputing(testApp);
    ...
    public void testComputeAllSitesResults() {
        ...
        assertEquals(testFoot.computeAllSitesResults(testSites).size(), 0);

        testSites.add(s1);
        assertEquals(testFoot.computeAllSitesResults(testSites).size(), 1);

        testSites.add(s2);
        assertEquals(testFoot.computeAllSitesResults(testSites).size(), 2);
    }
}
