...
public class FunctionalIndicesComputingTest {


    private AppInterface testApp;
    private FunctionalIndicesComputing testFunction;
    ...
    public void setUp() {
        ...
        testFunction = new FunctionalIndicesComputing(testApp);
    ...
    public void testComputeAllSitesResults() {
        ...
        assertEquals(testFunction.computeAllSitesResults(testSites).size(), 0);

        testSites.add(s1);
        assertEquals(testFunction.computeAllSitesResults(testSites).size(), 1);

        testSites.add(s2);
        assertEquals(testFunction.computeAllSitesResults(testSites).size(), 2);
    }
}
