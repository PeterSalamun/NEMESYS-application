...
public class SelecteAllButtonTest {

    private SelectAllButton testT;
    ...
    public void testAddToParent() {
        ...
        testT = new SelectAllButton(app, parent);
    ...
    @Test
    public void testClickSelectAllButton() {
        assertTrue(app.getDatabaseMap().isEmpty());
        testT = new SelectAllButton(app, parent);
        DeselectAllButton deselect = new DeselectAllButton(app, parent);
        assertTrue(testT.isActive());
