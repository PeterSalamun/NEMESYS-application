...
public class TrophicComputingTest {

    private AppInterface testApp;
    private TrophicComputing testTrophic;
    ...
    public void setUp() {
        ...
        testTrophic = new TrophicComputing(testApp);
    ...
    public void testComputeAllSitesResults() {
        ...
        assertEquals(testTrophic.computeAllSitesResults(testSites).size(), 0);

        testSites.add(s1);
        assertEquals(testTrophic.computeAllSitesResults(testSites).size(), 1);

        testSites.add(s2);
        assertEquals(testTrophic.computeAllSitesResults(testSites).size(), 2);
    }
}
