...
public class FootprintsSheet extends BasicSheet {
    ...
    //EFFECTS: initializing GeneralComputing by calling FootprintsComputing
    @Override
    ...
    //MODIFIES: XSSFSheet
    //EFFECTS: obtains results for footprints values and write them in to the XSSFSheet
    ...
    //REQUIRES: XSSFRow
    // MODIFIES: XSSFSheet
    // EFFECTS: add cell at the end of row, customize it and fill with massName
